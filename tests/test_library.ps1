...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$ResultRun = RunTestBinary ${TestExecutablesDirectory} "fdatetime_test_${TestName}"
...
$TestInputs = GenerateTestInputs "libfdatetime" ${OptionSets}
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$ResultRun = RunTestBinaryWithInput ${TestExecutablesDirectory} "fdatetime_test_${TestName}" ${TestInput}
